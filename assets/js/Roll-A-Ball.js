    ...
    return function e(t, n, o) {
      ...
      7: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
          var n, a, r, s, d, l, u, c, f, h, p, m, w, b, g, v, k, y, _, S, x, M, C, E, R;
          n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, R = e.output, d = s - (t - e.avail_out), l = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, w = n.bits, b = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
          e: do {
              ...
              if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _) R[s++] = 65535 & y;
                ...
                n: for (;;) {
                  ...
                  if (m >>>= _, w -= _, _ = s - d, x > _) {
                    ...
                    for (; S > 2;) R[s++] = C[M++], R[s++] = C[M++], R[s++] = C[M++], S -= 3;
                    S && (R[s++] = C[M++], S > 1 && (R[s++] = C[M++]))
                  } else {
                    M = s - x;
                    do R[s++] = R[M++], R[s++] = R[M++], R[s++] = R[M++], S -= 3; while (S > 2);
                    S && (R[s++] = R[M++], S > 1 && (R[s++] = R[M++]))
                  }
                  break
                }
              }
      ...
      8: [function(e, t, n) {
        ...
        function a(e) {
          var t;
          return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = U, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new b.Buf32(pe), t.distcode = t.distdyn = new b.Buf32(me), t.sane = 1, t.back = -1, R) : I
        }

        function r(e) {
          var t;
          return e && e.state ? (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, a(e)) : I
        }

        function s(e, t) {
          var n, o;
          return e && e.state ? (o = e.state, 0 > t ? (n = 0, t = -t) : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15) ? I : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, r(e))) : I
        }

        function d(e, t) {
          var n, o;
          return e ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== R && (e.state = null), n) : I
        }
        ...
        function f(e, t) {
          ...
          n = e.state, n.mode === W && (n.mode = K), s = e.next_out, a = e.output, l = e.avail_out, r = e.next_in, i = e.input, d = e.avail_in, f = n.hold, h = n.bits, p = d, m = l, Se = R;
          e: for (;;) switch (n.mode) {
            case U:
              if (0 === n.wrap) {
                n.mode = K;
          ...
          return e.next_out = s, e.avail_out = l, e.next_in = r, e.avail_in = d, n.hold = f, n.bits = h, (n.wsize || m !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = fe, L) : (p -= e.avail_in, m -= e.avail_out, e.total_in += p, e.total_out += m, n.total += m, n.wrap && m && (e.adler = n.check = n.flags ? v(n.check, a, m, e.next_out - m) : g(n.check, a, m, e.next_out - m)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === W ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === p && 0 === m || t === M) && Se === R && (Se = B), Se)
        }
        ...
        function p(e, t) {
          var n;
          return e && e.state ? (n = e.state, 0 === (2 & n.wrap) ? I : (n.head = t, t.done = !1, R)) : I
        }
      ...
      9: [function(e, t, n) {
        ...
        t.exports = function(e, t, n, p, m, w, b, g) {
          var v, k, y, _, S, x, M, C, E, R = g.bits,
            D = 0,
            A = 0,
            I = 0,
            F = 0,
          ...
          for (L = R, F = i; F >= 1 && 0 === Z[F]; F--);
          if (L > F && (L = F), 0 === F) return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
          for (I = 1; F > I && 0 === Z[I]; I++);
          for (I > L && (L = I), U = 1, D = 1; i >= D; D++)
            if (U <<= 1, U -= Z[D], 0 > U) return -1;
          if (U > 0 && (e === s || 1 !== F)) return -1;
          for (q[1] = 0, D = 1; i > D; D++) q[D + 1] = q[D] + Z[D];
          for (A = 0; p > A; A++) 0 !== t[n + A] && (b[q[t[n + A]]++] = A);
          if (e === s ? (T = G = b, x = 19) : e === d ? (T = u, P -= 257, G = c, H -= 257, x = 256) : (T = f, G = h, x = -1), z = 0, A = 0, D = I, S = w, B = L, O = 0, y = -1, N = 1 << L, _ = N - 1, e === d && N > a || e === l && N > r) return 1;
          for (var j = 0;;) {
            j++, M = D - O, b[A] < x ? (C = 0, E = b[A]) : b[A] > x ? (C = G[H + b[A]], E = T[P + b[A]]) : (C = 96, E = 0), v = 1 << D - O, k = 1 << B, I = k;
            do k -= v, m[S + (z >> O) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
            for (v = 1 << D - 1; z & v;) v >>= 1;
            if (0 !== v ? (z &= v - 1, z += v) : z = 0, A++, 0 === --Z[D]) {
              if (D === F) break;
              D = t[n + b[A]]
            }
            if (D > L && (z & _) !== y) {
              for (0 === O && (O = L), S += I, B = D - O, U = 1 << B; F > B + O && (U -= Z[B + O], !(0 >= U));) B++, U <<= 1;
              if (N += 1 << B, e === d && N > a || e === l && N > r) return 1;
              y = z & _, m[y] = L << 24 | B << 16 | S - w | 0
            }
          }
          return 0 !== z && (m[S + z] = D - O << 24 | 64 << 16 | 0), g.bits = L, 0
        }
      }, {
        "../utils/common": 1
      }],
  ...
  function() {
    var e = function(e) {
      ...
      function n() {
        ...
        }, new t(0, 139659, 0, 0).open("GET", "/data.unity3d"), new t(139659, 139680, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(139680, 142655, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(142655, 2010247, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(2010247, 2885219, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(2885219, 2912844, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_Roll-A-Ball.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
          fromCache: !1
        }, d ? (n(d), d = null) : l = n
      }
      var o;
